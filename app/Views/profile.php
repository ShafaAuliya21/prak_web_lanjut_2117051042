...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div style="text-align:center;">
        <img src="<?php echo base_url('fotoShafaauliya.jpg'); ?>" alt="fotoroy" style="height: 260px; width: 260px; border-radius: 50%; object-fit: cover; object-position: 0 -8px;"  border="2px" ><br>
        <b><p><h3>Hi</h3></p></b> 
